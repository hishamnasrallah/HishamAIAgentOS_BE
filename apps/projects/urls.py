...
from .views import (
    ...
    ProjectMemberViewSet, GeneratedProjectViewSet, ProjectFileViewSet, RepositoryExportViewSet
)
...
router.register(r'generated-projects', GeneratedProjectViewSet, basename='generatedproject')
router.register(r'project-files', ProjectFileViewSet, basename='projectfile')
router.register(r'repository-exports', RepositoryExportViewSet, basename='repositoryexport')
...
urlpatterns = [
    ...
    path('<uuid:pk>/members/<uuid:user_id>/statistics/', ProjectViewSet.as_view({'get': 'member_statistics'}), name='project-member-statistics'),
